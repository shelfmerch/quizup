  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto">
      <div className="quizup-header-teal px-4 py-3 flex items-center gap-3 shadow-sm">
        ...
        <h1 className="font-display font-bold text-white text-base">Create Account</h1>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex justify-center mb-6">
            <div 
              className="relative w-24 h-24 rounded-full bg-white border-2 border-slate-200 flex items-center justify-center cursor-pointer overflow-hidden group shadow-sm"
