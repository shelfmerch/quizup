...
const QUESTIONS = {
  ...
  "name-the-animal": [
    { text: "This animal is primarily found in which region?", options: ["South America", "Africa", "Europe", "Australia"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/baboon.png" },
    { text: "This animal belongs to which group?", options: ["Fish", "Amphibians", "Marine mammals", "Reptiles"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/seal.png" },
    { text: "What is the main diet of this animal?", options: ["Meat", "Fruits", "Bamboo", "Fish"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/panda.png" },
    { text: "This animal is best adapted to which environment?", options: ["Desert", "Tropical forest", "Arctic region", "Grasslands"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/polarbear.png" },
    { text: "Why does this bird peck tree trunks?", options: ["To drink water", "To find insects", "To build nests only", "To sharpen beak"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/woodpecker.png" },
    { text: "What is unique about this animal?", options: ["It can fly", "Male carries the eggs", "It has no eyes", "It breathes air"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/seahorse.png" },
    { text: "The horns (antlers) of this animal are mostly found on:", options: ["Both genders", "Only females", "Only males", "Neither"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/deer.png" },
    { text: "This insect is known for its ability to:", options: ["Walk long distances", "Swim underwater", "Fly in multiple directions", "Change color"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/dragonfly.png" },
    { text: "This fish is commonly found in which river system?", options: ["Nile", "Amazon", "Ganges", "Yangtze"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/piranha.png" },
    { text: "The long “saw-like” snout of this fish is mainly used for:", options: ["Swimming faster", "Attracting mates", "Hunting prey", "Breathing"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/sawfish.png" },

    { text: "Which animal is shown in the image?", options: ["Jellyfish", "Octopus", "Starfish", "Sea anemone"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/jellyfish.png" },
    { text: "Which animal is shown in the image?", options: ["Hippo", "Rhinoceros", "Buffalo", "Elephant"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/rhino.png" },
    { text: "Which animal is shown in the image?", options: ["Chimpanzee", "Gorilla", "Orangutan", "Baboon"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/gorilla.png" },
    { text: "Which animal is shown in the image?", options: ["Koala", "Sloth", "Lemur", "Opossum"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/sloth.png" },
    { text: "Which animal is shown in the image?", options: ["Leopard", "Cheetah", "Tiger", "Lynx"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/cheetah.png" },
    { text: "Which animal is shown in the image?", options: ["Snow leopard", "Clouded leopard", "Jaguar", "Cheetah"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/snowleopard.png" },
    { text: "Which reptile is shown in the image?", options: ["Crocodile", "Komodo dragon", "Monitor lizard", "Iguana"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/komodo-dragon.png" },
    { text: "Which animal is shown in the image?", options: ["Bobcat", "Lynx", "Caracal", "Cougar"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/lynx.png" },
    { text: "Which animal is shown in the image?", options: ["Otter", "Platypus", "Beaver", "Seal"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/platypus.png" },
    { text: "Which animal is shown in the image?", options: ["Koala", "Panda", "Sloth", "Lemur"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/koala.png" },
    { text: "Which snake is shown in the image?", options: ["Cobra", "Rattlesnake", "Python", "Viper"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/rattlesnake.png" },
    { text: "Which reptile is shown in the image?", options: ["Chameleon", "Iguana", "Gecko", "Komodo dragon"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/iguana.png" },
    { text: "Which bird is shown in the image?", options: ["Kingfisher", "Blue jay", "Hummingbird", "Woodpecker"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/kingfisher.png" },
    { text: "Which extinct bird is shown in the image?", options: ["Dodo", "Emu", "Kiwi", "Penguin"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/dodo.png" },
    { text: "Which animal is shown in the image?", options: ["Walrus", "Sea lion", "Seal", "Manatee"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/walrus.png" },
    { text: "Which animal is shown in the image?", options: ["Otter", "Beaver", "Capybara", "Marmot"], correctIndex: 1, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/beaver.png" },
    { text: "Which bird is shown in the image?", options: ["Ostrich", "Flamingo", "Emu", "Crane"], correctIndex: 0, timeLimit: 10, imageUrl: "/uploads/name-the-animal-seed/ostrich.png" },
  ...
  "name-the-celebrity": [
    ...
    { text: "Who is this 20th-century political figure?", options: ["Winston Churchill", "Joseph Stalin", "Adolf Hitler", "Benito Mussolini"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/hitler.png" },
    { text: "This character from Doraemon is best known as:", options: ["Nobita", "Shizuka", "Gian (Takeshi)", "Suneo"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/gian.png" },
    { text: "Who is shown in the image?", options: ["Moon Jae-in", "Xi Jinping", "Kim Jong Un", "Shinzo Abe"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/kim-jong-un.png" },
    { text: "Who is this Pakistani actress?", options: ["Sajal Aly", "Ayeza Khan", "Mahira Khan", "Mehwish Hayat"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/mahira-khan.png" },
    { text: "Who is this South Korean actor?", options: ["Park Seo-joon", "Hyun Bin", "Gong Yoo", "Song Joong-ki"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/gong-yoo.png" },
    { text: "Who is this singer?", options: ["Katy Perry", "Ariana Grande", "Taylor Swift", "Lady Gaga"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/taylor-swift.png" },
    { text: "Who is shown in the image?", options: ["Kylie Jenner", "Kendall Jenner", "Kim Kardashian", "Khloé Kardashian"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/kim-kardashian.png" },
    { text: "Who is this footballer?", options: ["Cristiano Ronaldo", "Neymar", "Lionel Messi", "Kylian Mbappé"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/lionel-messi.png" },
    { text: "Who is this South Korean actress?", options: ["Song Hye-kyo", "Park Shin-hye", "Jun Ji-hyun", "Son Ye-jin"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/jun-ji-hyun.png" },
    { text: "Who is this singer?", options: ["Olivia Rodrigo", "Dua Lipa", "Billie Eilish", "Ariana Grande"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/billie-eilish.png" },
    { text: "Who is this South Korean actor?", options: ["Gong Yoo", "Lee Jung-jae", "Lee Min-ho", "Park Hyung-sik"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/lee-min-ho.png" },
    { text: "Who is this scientist?", options: ["Albert Einstein", "Neil deGrasse Tyson", "Stephen Hawking", "Richard Feynman"], correctIndex: 2, timeLimit: 10, imageUrl: "/uploads/name-the-celebrity-seed/stephen-hawking.png" },
