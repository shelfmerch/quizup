...
const { uploadCommunityImage, uploadCommunityVideo } = require("../controllers/communityUploadController");
...
router.post("/upload-video", requireAuth, uploadCommunityVideo);
